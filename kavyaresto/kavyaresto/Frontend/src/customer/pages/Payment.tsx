...
const Payment: React.FC = () => {
  ...
  const confirmOrder = () => {
    ...
    setTimeout(() => {
      ...
      sessionStorage.setItem('paymentCompleted', 'true')
      sessionStorage.setItem('paymentMethod', selectedPayment || (selectedWallet ? `wallet:${selectedWallet}` : 'unknown'))
      sessionStorage.setItem('orderType', selectedMode || orderType)
      sessionStorage.setItem('orderTotal', total.toFixed(2))
      clearCart()
    }, 400)
    setTimeout(() => {
